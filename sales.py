...
class salesClass:
    def __init__(self, root):
        ...
        btn_clear = Button(self.root, text="Clear", command=self.clear, font=("times new roman", 15, "bold"), bg="lightgray", cursor="hand2")
        ...
        # Image
        try:
            self.bill_photo = Image.open("images/image.png")
    ...
    def show(self):
        ...
        if not os.path.exists('bill'):
            os.makedirs('bill')
        # List .txt files in the 'bill' directory
